...
//!
//! These types support the feedback collection system for Fuigo sessions.
//! The agent (fuigo-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using Fuigo Code productively! Would you mind sharing quick feedback?".to_string()
}
