//! Unified MCP adapter for the Ferrox Labs Computer Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](fuigo_computer_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](fuigo_computer_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
