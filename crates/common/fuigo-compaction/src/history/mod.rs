...
//! string/text manipulation. Harness-bound extraction (Fuigo chat's
//! `FuigoConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `FuigoMessage` assembly) stays in the harness crate.
