//! Observability seam for the full-replace (fuigo-build) pass.
//!
//! The shared orchestrator reports per-attempt and terminal outcomes through
//! this trait so each harness can emit its own telemetry (fuigo-build:
...
//!
//! Emission points are part of the behavior contract: the fuigo-build observer
