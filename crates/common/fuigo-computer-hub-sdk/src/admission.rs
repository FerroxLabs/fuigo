...
/// Numeric JSON-RPC code for overload rejection (`fuigo-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "FUIGO_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `FUIGO_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
