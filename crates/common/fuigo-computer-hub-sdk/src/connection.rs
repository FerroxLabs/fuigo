...
struct WaiterGuard<'a> {
    demux: &'a Demux,
    request_id: &'a fuigo_tool_protocol::RequestId,
}
...
pub struct ConnectionConfig {
    ...
    pub server_id: Option<fuigo_tool_protocol::ServerId>,
...
impl HubConnection {
    ...
    pub async fn call_request<P>(
        &self,
        request_id: fuigo_tool_protocol::RequestId,
    ...
    pub fn try_alloc_request_id(&self) -> Result<fuigo_tool_protocol::RequestId, ClientError> {
        let value = self
            .inner
            .next_request_id
            .fetch_add(1, std::sync::atomic::Ordering::Relaxed);
        fuigo_tool_protocol::RequestId::new(format!("c{value}")).map_err(ClientError::from)
    }
    ...
    pub async fn serve(
        ...
        params: fuigo_tool_protocol::ServeParams,
    ) -> Result<fuigo_tool_protocol::ServeResult, ClientError> {
...
async fn open_socket(
    ...
    fuigo_tracing::http_client::attach_trace_to_http_request(headers);
...
async fn run_handshake(
    ...
    (
        ...
        fuigo_tool_protocol::HelloAckMsg,
    ),
    ClientError,
> {
    let ack = send_hello(
    ...
    if inner.kind == ConnectionKind::Harness {
        for sid in &sessions {
            let req = fuigo_tool_protocol::JsonRpcRequest {
                ...
                id: fuigo_tool_protocol::JsonRpcId::new_uuid_v7(),
