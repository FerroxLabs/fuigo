...
fn map_block(block: fuigo_tool_protocol::McpBlock) -> ContentBlock {
    use fuigo_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: fuigo_tool_protocol::JsonRpcError) -> ToolError {
