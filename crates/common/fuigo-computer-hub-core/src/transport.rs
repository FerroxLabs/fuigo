...
//!
//! [`TransportKind`] is re-exported from [`fuigo_tool_protocol`] so the wire
...
use fuigo_tool_protocol::{SessionId, ToolId, UserId};
use fuigo_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use fuigo_tool_protocol::TransportKind;
