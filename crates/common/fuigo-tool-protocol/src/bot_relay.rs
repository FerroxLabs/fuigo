...
pub enum BotRelayErrorCode {
    IdentityUnavailable,
    /// The Ferrox Labs account has never been linked to a Cursor account. The user
    ...
    /// The Ferrox Labs account has no verified email, so no Cursor account can be
    /// matched or created. Fixable on the Ferrox Labs side.
    EmailUnverified,
