//! Wire types for the `fuigo-workspace` API.
//!
...
//! That codegen step is **not** implemented yet; it will land alongside the `fuigo-workspace-grpc` crate.
...
/// Re-exported by `fuigo_workspace::permission` for callers that historically imported it from there.
