...
/// Claude.md / `.fuigo/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.fuigo` and compat dirs.
...
/// Mirrors the serde shape of `fuigo-agent`'s `AgentConfigFile`.
