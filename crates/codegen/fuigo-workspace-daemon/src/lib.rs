...
//!
//! Two halves of one concern, both used only by the `fuigo-workspace-server` binary and never by the `fuigo-workspace` library:
//!
...
//!
//! This crate deliberately does not depend on `fuigo-workspace`.
