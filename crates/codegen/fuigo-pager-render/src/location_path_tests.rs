...
#[test]
fn shorten_location_path_kerem_fuigo_home() {
    assert_eq!(
        shorten_location_path("~/.fuigo/worktrees/code-xai/dashboard-design").as_ref(),
        "~/.f/w/code-xai/dashboard-design"
    );
    assert_eq!(
        shorten_location_path("$FUIGO_HOME/worktrees/code-xai/dashboard-design").as_ref(),
        "$FUIGO_HOME/w/code-xai/dashboard-design"
    );
}
...
fn shorten_location_path_short_paths_leave_alone() {
    ...
    assert_eq!(shorten_location_path("~/.fuigo").as_ref(), "~/.fuigo");
    assert_eq!(
        shorten_location_path("~/.fuigo/worktrees").as_ref(),
        "~/.fuigo/worktrees"
    );
    assert_eq!(shorten_location_path("$FUIGO_HOME").as_ref(), "$FUIGO_HOME");
    assert_eq!(
        shorten_location_path("$FUIGO_HOME/worktrees").as_ref(),
        "$FUIGO_HOME/worktrees"
    );
...
#[test]
fn shorten_location_path_does_not_eat_fuigo_home_lookalike() {
    assert_eq!(
        shorten_location_path("$FUIGO_HOME_BACKUP/a/b/c").as_ref(),
        "$/a/b/c"
    );
}
