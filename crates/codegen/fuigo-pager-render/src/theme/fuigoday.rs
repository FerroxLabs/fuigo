//! FuigoDay is the light counterpart to FuigoNight.
//! Backgrounds and text use a neutral grayscale ramp (no blue/warm tint).
//! Accent colors are the same hue family as FuigoNight but deepened for contrast on light backgrounds.
