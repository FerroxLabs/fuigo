//! Tracing layer that folds the span tree by wall time when `FUIGO_SPAN_PROFILE_OUT` names an output; inert otherwise.
...
pub const OUT_ENV: &str = "FUIGO_SPAN_PROFILE_OUT";
