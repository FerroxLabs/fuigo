...
//! Otherwise the standard vars could point both the internally-authed firehose and the customer collector at one endpoint, leaking Ferrox Labs credentials.
