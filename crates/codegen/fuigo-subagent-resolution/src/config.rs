...
//! The shell re-exports them via `fuigo_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `fuigo-shell` (on `SubagentsConfig`):
...
"#;
        ...
        assert_eq!(
            ...
            Some(".fuigo/prompts/researcher.md")
        );
