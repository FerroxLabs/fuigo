...
//!
//! Extracted from `fuigo-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use serde::de::DeserializeOwned;
use fuigo_tools::implementations::fuigo_build::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use fuigo_tools::implementations::fuigo_build::task::types::ModelOverrideProvenance;
    ...
    fn explicit_model_overrides_role() {
        let overrides = make_overrides(Some("fuigo-light"), None, None, None, None);
        ...
        assert_eq!(result.model.as_deref(), Some("fuigo-light"));
    }
