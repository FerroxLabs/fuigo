...
//! cargo run -p fuigo-sandbox --example sandbox_smoke_test
//!
//! # Test strict profile
//! cargo run -p fuigo-sandbox --example sandbox_smoke_test -- strict
//!
...
fn main() {
    ...
    let tmp_test = Path::new("/tmp/.fuigo-sandbox-test");
