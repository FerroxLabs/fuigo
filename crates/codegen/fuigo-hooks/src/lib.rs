//! # fuigo-hooks
//!
//! Runtime hook system for Fuigo: file-based discovery, command execution, and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Fuigo. Hooks are discovered
//! from dedicated directories (`~/.fuigo/hooks/` and `<git-worktree-root>/.fuigo/hooks/`),
...
//!     Some(Path::new("/home/user/.fuigo/hooks")),
//!     Some(Path::new("/project/.fuigo/hooks")),
//! );
//!
//! for err in &errors {
