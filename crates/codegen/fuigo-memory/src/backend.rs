...
use fuigo_tools::types::memory_backend::{MemoryBackend, MemorySearchResult};
...
pub struct EndpointScopedCredentials {
    ...
    auth_credentials: Option<Arc<dyn fuigo_auth::AuthCredentialProvider>>,
...
impl EndpointScopedCredentials {
    ...
    fn auth_credentials(&self) -> Option<&Arc<dyn fuigo_auth::AuthCredentialProvider>> {
        self.auth_credentials.as_ref()
    }

    fn api_key_provider(&self) -> Option<&fuigo_tools::types::SharedApiKeyProvider> {
...
pub struct MemoryBackendParams {
    ...
    pub embed_config: Option<fuigo_config_types::MemoryEmbeddingConfig>,
    ...
    pub search_config: fuigo_config_types::MemorySearchConfig,
...
async fn build_embedding_provider(
    config: Option<&fuigo_config_types::MemoryEmbeddingConfig>,
...
pub struct MemoryBackendImpl {
    ...
    embed_config: Option<fuigo_config_types::MemoryEmbeddingConfig>,
    ...
    search_config: fuigo_config_types::MemorySearchConfig,
...
impl MemoryBackendImpl {
    ...
    pub fn new(db_path: PathBuf, storage: MemoryStorage) -> Self {
        Self {
            ...
            embed_api_key: None,
            search_config: fuigo_config_types::MemorySearchConfig::default(),
            watcher: None,
            stale_claim_secs: 60,
    ...
    pub fn with_search_config(mut self, config: fuigo_config_types::MemorySearchConfig) -> Self {
    ...
    fn open_readonly(&self) -> Result<rusqlite::Connection, rusqlite::Error> {
        ...
        fuigo_sqlite_journal::JournalMode::for_db_path(&self.db_path).open_readonly(&self.db_path)
    }
...
#[cfg(test)]
impl MemoryBackendImpl {
    pub fn search_config_for_test(&self) -> &fuigo_config_types::MemorySearchConfig {
        &self.search_config
    }
}
...
mod factory_tests {
    ...
    fn test_factory_wires_non_overridable_search_config_fields() {
        ...
        let custom_search = MemorySearchConfig {
            max_results: 7,
            mmr: fuigo_config_types::MmrConfig {
                enabled: true,
                lambda: 0.42,
            },
            temporal_decay: fuigo_config_types::TemporalDecayConfig {
                enabled: true,
                half_life_days: 14.0,
            },
            ..Default::default()
    ...
    async fn make_embedding_provider_uses_async_api_key_resolution() {
        ...
        let probe: fuigo_tools::types::SharedApiKeyProvider = Arc::new(AsyncProbe {
...
mod tests {
    ...
    struct PanicKey;
    impl fuigo_tools::types::ApiKeyProvider for PanicKey {
        fn current_api_key(&self) -> Option<String> {
    ...
    async fn test_build_drops_credentials_when_request_url_differs() {
        let session: fuigo_tools::types::SharedApiKeyProvider = Arc::new(PanicKey);
        ...
        let config = fuigo_config_types::MemoryEmbeddingConfig {
    ...
    async fn test_trusted_endpoint_prefers_session_credential() {
        struct StubAuth;
        impl fuigo_auth::HttpAuth for StubAuth {
            fn apply(
                &self,
        ...
        #[async_trait::async_trait]
        impl fuigo_auth::AuthCredentialProvider for StubAuth {
            fn snapshot(&self) -> fuigo_auth::CredentialSnapshot {
                fuigo_auth::CredentialSnapshot::default()
            }
        ...
        let api_key: fuigo_tools::types::SharedApiKeyProvider = Arc::new(PanicKey);
        let scoped = EndpointScopedCredentials::for_endpoint(
            "https://api.x.ai/v1",
            |_| true,
            Some(auth),
    ...
    fn endpoint_scoped_credentials_trust_gate_and_url_match() {
        ...
        let key = || Arc::new(AnyKey) as fuigo_tools::types::SharedApiKeyProvider;
