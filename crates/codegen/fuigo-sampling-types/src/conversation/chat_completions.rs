...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        ChatCompletionRequest {
            ...
            x_fuigo_conv_id: req.x_fuigo_conv_id,
            x_fuigo_req_id: req.x_fuigo_req_id,
            x_fuigo_session_id: req.x_fuigo_session_id,
            x_fuigo_turn_idx: req.x_fuigo_turn_idx,
            x_fuigo_transient_retry: req.x_fuigo_transient_retry,
            x_fuigo_agent_id: req.x_fuigo_agent_id,
            x_fuigo_deployment_id: req.x_fuigo_deployment_id,
            x_fuigo_user_id: req.x_fuigo_user_id,
            trace: None,
        }
    }
}
