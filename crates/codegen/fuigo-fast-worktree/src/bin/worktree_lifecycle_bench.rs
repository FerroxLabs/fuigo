...
#[command(about = "Cross-transport fuigo-fast-worktree/Grove lifecycle sampler")]
struct Cli {
...
fn run_controller_inner(
    ...
    let tracked_files = fuigo_fast_worktree::count_tracked_files(&source)?;
...
fn cleanup_grove_identity(target: &CleanupTarget) -> Result<()> {
    ...
    let pin = format!("refs/fuigo/worktrees/{}", target.worktree_id);
...
const HARNESS_INPUT_PATHS: &[&str] = &[
    "crates/codegen/fuigo-fast-worktree/src/bin/worktree_lifecycle_bench.rs",
    "crates/codegen/fuigo-fast-worktree/src/bin/worktree_lifecycle_bench/runtime.rs",
    "crates/codegen/fuigo-fast-worktree/Cargo.toml",
    "crates/codegen/fuigo-fast-worktree/BUILD.bazel",
    "Cargo.lock",
    "rust-toolchain.toml",
    ".bazelrc",
];
