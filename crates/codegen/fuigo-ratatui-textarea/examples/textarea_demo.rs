...
//!
//! Run with: cargo run -p fuigo-ratatui-textarea --example textarea_demo
//!
...
use fuigo_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use fuigo_ratatui_textarea::{
