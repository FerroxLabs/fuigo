//! On-disk cache for the subagent bundle Ferrox Labs publishes: personas, roles, agents, skills, and workflows written under `<fuigo home>/bundled`.
//!
...
pub fn bundled_root() -> PathBuf {
    fuigo_config::fuigo_home().join(BUNDLED_DIR_NAME)
}
