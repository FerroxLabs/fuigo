...
use fuigo_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (fuigo_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    fuigo_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use fuigo_shell::tools::{TodoItem, TodoPriority};
