...
use fuigo_mcp::rmcp;
use fuigo_mcp::servers::{McpClient, parse_mcp_qualified_name};
...
/// Extract a server name from an [`McpError`](fuigo_mcp::servers::McpError), falling back to `"unknown"`.
pub(crate) fn server_name_from_mcp_error(e: &fuigo_mcp::servers::McpError) -> &str {
...
mod tests {
    use super::*;
    use fuigo_computer_hub_mcp_adapter::{McpBridge, McpError};
