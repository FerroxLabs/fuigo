...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        env: "FUIGO_COMPACTION_VERBATIM_INPUT",
        default_enabled: true,
    ...
    FeatureSpec {
        ...
        env: "FUIGO_SUBAGENT_WORKTREE_SNAPSHOT",
        default_enabled: false,
    ...
    FeatureSpec {
        ...
        env: "FUIGO_ACTIVE_AGENT_MESSAGES",
        default_enabled: false,
