//! Memory-system configuration value types, extracted from fuigo-shell so crates the shell depends on can use them.
//!
...
///
/// When enabled, watches `~/.fuigo/memory/` for `.md` file changes (create,
...
///
/// On session init, directories under `~/.fuigo/memory/` are scanned:
...
impl MemoryConfig {
    ...
    pub fn resolve_settings(
        ...
        Self {
            enabled: crate::BoolFlag::env("FUIGO_MEMORY")
