...
fn registered_settings() {
    ...
    assert_eq!(
        rows,
        BTreeMap::from([
            ("session_search", ("FUIGO_SESSION_SEARCH", true)),
            ("lsp_tools", ("FUIGO_LSP_TOOLS", false)),
            ("web_fetch", ("FUIGO_WEB_FETCH", false)),
            ("session_recap", ("FUIGO_SESSION_RECAP", true)),
            ("ask_user_question", ("FUIGO_ASK_USER_QUESTION", true)),
            ("voice_mode", ("FUIGO_VOICE_MODE", true)),
            ("write_file", ("FUIGO_WRITE_FILE", true)),
            ("feedback", ("FUIGO_FEEDBACK_ENABLED", true)),
            ("feedback_trace_card", ("FUIGO_FEEDBACK_TRACE_CARD", false)),
            ("turn_summary", ("FUIGO_TURN_SUMMARY", true)),
            ("cancel_rewind", ("FUIGO_CANCEL_REWIND", true)),
            (
                "compaction_verbatim_input",
                ("FUIGO_COMPACTION_VERBATIM_INPUT", true),
            ),
            ("two_pass_compaction", ("FUIGO_TWO_PASS_COMPACTION", true)),
            ("backend_tools", ("FUIGO_BACKEND_SEARCH", true)),
            ("auto_wake", ("FUIGO_AUTO_WAKE", true)),
            (
                "subagent_worktree_snapshot",
                ("FUIGO_SUBAGENT_WORKTREE_SNAPSHOT", false),
            ),
            (
                "active_agent_messages",
                ("FUIGO_ACTIVE_AGENT_MESSAGES", false),
            ),
            (
...
fn off_reason_names_the_setting_that_turned_it_off() {
    ...
    for (sources, reason) in [
        ...
        (
            ...
            "the FUIGO_SESSION_SEARCH environment variable",
        ),
        (
            FeatureSources {
                config: Some(false),
