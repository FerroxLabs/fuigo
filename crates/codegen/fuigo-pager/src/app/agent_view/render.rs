...
impl AgentView {
    ...
    /// The funnel for every apply that can be a resumed child's *first* live block: the ACP and Ferrox Labs child ingresses and the finish-path finalize.
    ...
    pub fn draw(
        ...
        agent::fill_background(buf, area, layout_cfg, compact, &theme);
        let mut status_line_link_spans: Vec<fuigo_ratatui_inline::LinkSpan> = Vec::new();
        ...
        let sticky_gap_row: Option<u16>;
        {
                ...
                && let Some(search) = self.scrollback_search.as_ref()
            {
                ...
                crate::views::picker::render_search_bar_with_viewport(
                    ...
                    !search.is_composing(),
                    None,
                    viewport.unwrap_or(fuigo_ratatui_textarea::SingleLineViewport {
            ...
            if route.emit_osc8 {
                ...
                *link_spans_out = self
                    ...
                    .filter_map(|link| {
                        ...
                        .map(|url| fuigo_ratatui_inline::LinkSpan {
                            row: link.screen_row,
    ...
    fn ctrl_f_hint_follows_the_key_in_every_focus_mode() {
        ...
        perm.options = vec![acp::PermissionOption::new(
            acp::PermissionOptionId::new(Arc::from(
                fuigo_workspace::permission::ALLOW_EDITS_SESSION_OPTION_ID,
            )),
