...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        fuigo_telemetry::session_ctx::log_event(fuigo_telemetry::events::PromptSuggestion {
            action: fuigo_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
            model: None,
            latency_ms: None,
...
mod plugin_cta_notify_tests {
    ...
    fn cta_entry(name: &str) -> fuigo_hooks_plugins_types::MarketplacePluginEntry {
