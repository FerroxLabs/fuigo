...
use fuigo_status_line::{ResolvedStatusLine, StatusLineConfig, StatusLineItem, StatusLineType};
...
impl StatusLineMetrics {
    ...
    pub(crate) fn report_config(&self, cfg: &StatusLineConfig) {
        ...
        fuigo_telemetry::session_ctx::log_event(fuigo_telemetry::events::StatusLineConfigured {
            kind,
    ...
    fn health_event(&self) -> Option<fuigo_telemetry::events::StatusLineHealth> {
        ...
        Some(fuigo_telemetry::events::StatusLineHealth {
            kind,
