...
fn plugins_list_response() -> fuigo_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    fuigo_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(fuigo_hooks_plugins_types::PluginOrigin::UserFuigo),
            ),
            test_plugin_info(
                "claude-tool",
                Some(fuigo_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
