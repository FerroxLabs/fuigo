...
fn open_extensions_modal_no_session_sets_flag_no_fetches() {
    ...
    let effects = dispatch(
        Action::OpenExtensionsModal {
            ...
            trigger: fuigo_telemetry::events::ExtensionsModalTrigger::SlashCommand,
        },
        &mut app,
    );
...
fn success_outcome() -> fuigo_hooks_plugins_types::ActionOutcome {
...
fn empty_marketplace_response() -> fuigo_hooks_plugins_types::MarketplaceListResponse {
    fuigo_hooks_plugins_types::MarketplaceListResponse { sources: vec![] }
}
