...
-> [fuigo_tools::implementations::fuigo_build::ask_user_question::QuestionOption; 2] {
    use fuigo_tools::implementations::fuigo_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// `worktree == false` emits [`Effect::ForkSession`], which calls `fuigo/session/fork` directly.
