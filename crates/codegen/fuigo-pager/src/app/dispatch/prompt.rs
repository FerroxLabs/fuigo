...
/// Start (if needed) and submit the initial prompt from `fuigo "<prompt>"`.
///
...
pub(super) fn dispatch_show_undo_tip(app: &mut AppView) -> Vec<Effect> {
    ...
    if agent.show_ephemeral_tip(
        ...
        log_event(fuigo_telemetry::events::ContextualTip {
            tip: fuigo_telemetry::events::ContextualTipKind::Undo,
...
pub(in crate::app) fn show_small_screen_tip(app: &mut AppView) {
    ...
    if agent.show_ephemeral_tip(
        ...
        log_event(fuigo_telemetry::events::ContextualTip {
            tip: fuigo_telemetry::events::ContextualTipKind::SmallScreen,
            action: fuigo_telemetry::events::ContextualTipAction::Shown,
        });
    }
}
...
pub(in crate::app) fn show_ssh_wrap_tip(app: &mut AppView) {
    ...
    if agent.show_ephemeral_tip(
        ...
        log_event(fuigo_telemetry::events::ContextualTip {
            tip: fuigo_telemetry::events::ContextualTipKind::SshWrap,
            action: fuigo_telemetry::events::ContextualTipAction::Shown,
        });
    }
}
...
pub(super) fn dispatch_show_plan_nudge(app: &mut AppView) -> Vec<Effect> {
    ...
    if agent.show_ephemeral_tip(
        ...
        log_event(fuigo_telemetry::events::ContextualTip {
            tip: fuigo_telemetry::events::ContextualTipKind::PlanMode,
            action: fuigo_telemetry::events::ContextualTipAction::Shown,
        });
    }
    vec![]
...
pub(super) fn dispatch_show_word_select_tip(app: &mut AppView) -> Vec<Effect> {
    ...
    if agent.show_ephemeral_tip(
        ...
        log_event(fuigo_telemetry::events::ContextualTip {
            tip: fuigo_telemetry::events::ContextualTipKind::WordSelect,
            action: fuigo_telemetry::events::ContextualTipAction::Shown,
        });
    }
...
pub(super) fn dispatch_accept_word_select_tip(app: &mut AppView) -> Vec<Effect> {
    ...
    log_event(fuigo_telemetry::events::ContextualTip {
        tip: fuigo_telemetry::events::ContextualTipKind::WordSelect,
        action: fuigo_telemetry::events::ContextualTipAction::Accepted,
    });
...
fn maybe_show_send_now_tip(app: &mut AppView) {
    ...
    if agent.show_ephemeral_tip(
        ...
        log_event(fuigo_telemetry::events::ContextualTip {
            tip: fuigo_telemetry::events::ContextualTipKind::SendNow,
            action: fuigo_telemetry::events::ContextualTipAction::Shown,
        });
    }
}
    ...
    if !literal && trimmed.starts_with('/') {
        ...
        let exec_result = {
            ...
            if let Some(invocation) = parse_invocation(trimmed) {
                ...
                {
                    use fuigo_telemetry::events::{PagerCommandSource, PagerSlashCommand};
                    use fuigo_telemetry::session_ctx::log_event;
