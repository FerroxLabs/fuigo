...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    fuigo_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        fuigo_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        fuigo_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        fuigo_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        fuigo_shell::session::PromptOrigin::TaskCompleted { .. }
            | fuigo_shell::session::PromptOrigin::SubagentCompleted { .. }
            | fuigo_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | fuigo_shell::session::PromptOrigin::ParentAgentMessage { .. }
            | fuigo_shell::session::PromptOrigin::NotificationDrain
    )
}
