...
fn upsert_workflow_block(
    ...
    objective: &str,
    status: &str,
    phases: &[fuigo_shell::extensions::notification::WorkflowPhaseInfo],
...
pub(super) fn ingest_workflow_update(agent: &mut AgentView, update: FuigoSessionUpdate) -> bool {
    let FuigoSessionUpdate::WorkflowUpdated {
        run_id,
        revision,
        name,
        objective,
