#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    #[test]
    fn workflow_updates_bypass_global_fuigo_highwater_and_use_run_revision() {
        let mut app = make_app_with_agent("sess-A");
        let id = AgentId(0);
        app.agents.get_mut(&id).unwrap().last_applied_fuigo_event_seq = Some(100);
        ...
        assert_eq!(app.agents[&id].last_applied_fuigo_event_seq, Some(100));
