#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn exec_vehicle_permission_enqueues_a_persisting_default_scope() {
        ...
        assert!(
            fuigo_workspace::permission::always_allow_scope_persists(
    ...
    fn mcp_elicit_does_not_replace_url_waiting() {
        ...
        );
        {
            ...
            assert!(ev.send_response(
                fuigo_tools::mcp_elicitation::McpElicitExtResponse::Accept { content: None },
            ));
    ...
    fn notify_status(app: &mut crate::app::app_view::AppView, cwd: &str) -> bool {
        let notif = SessionNotification {
            ...
            update: FuigoSessionUpdate::SessionStatus(Box::new(
    ...
    fn a_status_snapshot_repaints_a_row_that_had_already_settled() {
        ...
        app.current_ui.status_line =
            fuigo_status_line::test_support::StatusLineConfigFixture::from_kind(
                fuigo_status_line::StatusLineType::Builtin,
            )
            .with_items(vec![fuigo_status_line::StatusLineItem::Cwd])
            .into_config();
