...
impl WireErrorType {
    ...
    pub(crate) fn parse(raw: Option<&str>) -> Self {
        ...
        match s {
            ...
            s if s == fuigo_shell::extensions::notification::DISK_FULL_ERROR_TYPE => Self::DiskFull,
            s => s
                .parse::<fuigo_shell::sampling::error::SamplingErrorKind>()
                .map(Into::into)
...
impl From<fuigo_shell::sampling::error::SamplingErrorKind> for WireErrorType {
    fn from(kind: fuigo_shell::sampling::error::SamplingErrorKind) -> Self {
        use fuigo_shell::sampling::error::SamplingErrorKind as K;
        match kind {
            K::Auth => Self::Auth,
            K::Http => Self::Http,
            K::Api => Self::Api,
