...
pub enum NotificationProtocol {
    ...
    Osc9,
    /// Kitty: `\x1b]99;i=fuigo;{message}\x1b\\`
    Osc99,
...
pub fn select_protocol(ctx: &TerminalContext) -> NotificationProtocol {
    ...
    match ctx.brand {
        ...
        TerminalName::FuigoDesktop => NotificationProtocol::None,
