...
/// Thinking never breaks a run: a finished collapsed thought without prompt chrome folds in as [`RunStep::ThoughtMember`].
...
mod tests {
    ...
    fn web_search_counts_distinct_sources_with_call_fallback() {
        ...
        let entries = vec![
            searched("fuigo", &["https://a.com", "https://b.com"]),
