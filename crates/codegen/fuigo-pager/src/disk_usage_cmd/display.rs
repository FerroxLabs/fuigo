...
//! `fuigo_config::fuigo_home()`, whose first call creates the home, must stay out of this module.
...
pub fn print_missing_home(fuigo_home: &str, out: &mut impl Write) -> std::io::Result<()> {
    writeln!(
        out,
...
fn home_prefix_label(fuigo_home: &str) -> String {
    crate::util::display_fuigo_home_prefix_for(Path::new(fuigo_home))
}
