...
pub fn render_menu(
    ...
    for (i, (key, label)) in items.iter().enumerate() {
        ...
        // Terminal theme (Reset band slots): the selection cue is reverse video; the row is all
        // default-fg text so it inverts uniformly. RGB themes keep their bg_highlight band.
