...
mod tests {
    ...
    fn skills_groups_then_az_by_label() {
        ...
        project_z.config_source = Some(fuigo_tools::types::config_source::ConfigSource::Project {
        ...
        project_a.config_source = Some(fuigo_tools::types::config_source::ConfigSource::Project {
