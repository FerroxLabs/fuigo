...
pub fn render_dashboard(
    ...
    workspace_snapshot: Option<&fuigo_dashboard_store::WorkspaceSnapshot>,
...
///
/// ```text
///   ◆ Add responsiveness to /context · fuigo my-branch-2 worktree       4 mins
...
fn render_row(
    ...
    if title_avail > 0 {
        ...
        // Subtitle: ` · fuigo my-branch-2 worktree`.
...
/// Examples: `✗ Session no longer exists`, `✓ Theme: Fuigo Day`.
...
fn render_dispatch(
    ...
    if state.search_mode {
        ...
        let cursor_column = if state.dispatch.text().is_empty() {
            ...
            let viewport = fuigo_ratatui_textarea::EditBuffer::from_parts(
                state.dispatch.text(),
...
/// Process-wide cached home directory via [`fuigo_dirs::home_dir`].
