...
use fuigo_ratatui_textarea::{ElementId, ElementKind, TextArea, TextAreaState, TextElement};
...
pub struct PromptWidget {
    ...
    hovered_image_element_id: Option<fuigo_ratatui_textarea::ElementId>,
    /// Image shown immediately after insertion without moving the edit cursor.
    post_insert_image_preview: Option<(fuigo_ratatui_textarea::ElementId, usize)>,
...
impl PromptWidget {
    ...
    fn handle_key_inner(&mut self, key: &KeyEvent) -> PromptEvent {
        ...
        if changed {
            ...
            if is_backspace_key && !old_text.is_empty() {
                use fuigo_telemetry::events::BackspaceNoEffect;
    ...
    fn image_element_near_cursor(&self) -> Option<&fuigo_ratatui_textarea::TextElement> {
    ...
    pub fn textarea(&self) -> &fuigo_ratatui_textarea::TextArea {
        &self.textarea
    }
...
fn strip_all_elements(
    text: &str,
    cursor: usize,
    textarea: &fuigo_ratatui_textarea::TextArea,
) -> (String, usize) {
...
fn map_clean_offset_to_raw(
    text: &str,
    clean_offset: usize,
    elements: &[fuigo_ratatui_textarea::TextElement],
) -> usize {
    if elements.is_empty() {
