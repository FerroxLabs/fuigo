...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain fuigo in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain fuigo in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `fuigo_voice::STT_LANGUAGES`, the official Fuigo STT catalog
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain fuigo opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>`: `None` resolves to "fuigonight"
                default: "fuigonight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>`: `None` falls back to "fuigonight"
                default: "fuigonight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>`: `None` falls back to "fuigoday"
                default: "fuigoday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            kind: SettingKind::Bool {
                ...
                default: fuigo_shell::util::config::DEFAULT_REMEMBER_TOOL_APPROVALS,
            },
            restart_required: true,
            hidden_in_minimal: false,
        },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "fuigo", "switch"],
        ...
        // The `FUIGO_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Opt-in to provide Ferrox Labs the ability to retain and train on \
        ...
        // Default English; System (`auto`) follows the process locale when it maps to a Fuigo STT language
        // The catalog is the official STT languages (see fuigo_voice::STT_LANGUAGES)
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Fuigo STT). \
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "Show a `/doctor` tip when an SSH session is not using `fuigo wrap`.",
            keywords: &[
                "ssh",
                "wrap",
                "remote",
