#!/bin/bash
#
# Fuigo CLI installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
# Env: FUIGO_BIN_DIR, FUIGO_PROXY_URL
#
# Usage:
...
#   FUIGO_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
...
if [ "$os" = "windows" ]; then
    ...
    chmod +x "$binary_path"
    ln -sf "$binary_path" "$BIN_DIR/fuigo"
