...
//! These exercise the sibling `fuigo-pager-minimal` crate end-to-end through the built binary (which installs the minimal hook).
...
mod minimal_esc_hints_cancel_key;
