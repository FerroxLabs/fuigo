...
/// Regression guard for the `fuigo-ratatui-inline` rewrite (termwiz to anstyle-parse).
/// Minimal mode commits finalized assistant blocks into the terminal's NATIVE scrollback through `fuigo_ratatui_inline::Terminal::insert_before`.
