...
Learn how to install, configure, and extend Fuigo, the terminal-based AI coding assistant from Ferrox Labs.
...
Automate, script, and integrate Fuigo with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `fuigo -p`, output formats, CI/CD integration, and piping |
...
| 27 | [fuigo clone](27-fuigo-clone.md) | Depth-1 Grove clone, `--full-history`, and safe deepen/switch commands |
