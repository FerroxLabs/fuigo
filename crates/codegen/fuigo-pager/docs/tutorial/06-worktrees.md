...
Want Fuigo working on a feature while you (or another Fuigo session) work on
...
- **From the shell:**
  ...
  ```bash
  fuigo --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Fuigo sessions on the same repo simultaneously.
