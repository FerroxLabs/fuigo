...
Fear not — your settings, rules, and skills come with you. Fuigo
...
writes the items you selected into your `.fuigo` config. Re-run it anytime.
...
Run **`fuigo inspect`** in a repo to see every rules file, skill, and MCP
server Fuigo picked up, tagged with where it came from. Each compat source
