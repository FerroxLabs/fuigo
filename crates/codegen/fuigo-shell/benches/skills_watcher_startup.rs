...
//!
//! ```text
//! cargo bench -p fuigo-shell --bench skills_watcher_startup
//! # optional scale:
//! FUIGO_SKILLS_WATCHER_BENCH_DIRS=12000 cargo bench -p fuigo-shell --bench skills_watcher_startup
//! ```
//!
...
fn worktree_dir_count() -> usize {
    std::env::var("FUIGO_SKILLS_WATCHER_BENCH_DIRS")
        .ok()
...
fn build_fixture(worktree_dirs: usize) -> Fixture {
    ...
    let fuigo_home = root.path().join("fuigo-home");
