...
//!
//! Run: `cargo bench -p fuigo-shell --bench fork_copy`
...
use fuigo_shell::session::storage::{CopySessionOptions, JsonlStorageAdapter, StorageAdapter};
use fuigo_shell::session::testkit::synth::make_session_with_size_blocking;
