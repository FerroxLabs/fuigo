...
pub(crate) const ENV_COMPACTION_TOOL_CHOICE: &str = "FUIGO_COMPACTION_TOOL_CHOICE";
...
pub(crate) const ENV_AUTO_COMPACT_THRESHOLD_PERCENT: &str = "FUIGO_AUTO_COMPACT_THRESHOLD_PERCENT";

/// Precedence (highest first):
///   1. env `FUIGO_AUTO_COMPACT_THRESHOLD_PERCENT`
...
const ENV_COMPACTION_WALL_CLOCK_BUDGET_SECS: &str = "FUIGO_COMPACTION_WALL_CLOCK_SECS";

/// Precedence: env `FUIGO_COMPACTION_WALL_CLOCK_SECS`, then remote `RemoteSettings.compaction_wall_clock_budget_secs`, then the client default.
/// `0` **disables** it.
...
mod compaction_wall_clock_budget_tests {
    ...
    // Assumes FUIGO_COMPACTION_WALL_CLOCK_SECS is unset in the test env.
    #[test]
