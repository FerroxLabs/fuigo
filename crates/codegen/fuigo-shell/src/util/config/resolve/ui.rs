...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "FUIGO_SHOW_THINKING_BLOCKS";
...
pub const ENV_GROUP_TOOL_VERBS: &str = "FUIGO_GROUP_TOOL_VERBS";
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "FUIGO_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: `FUIGO_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle` > the parsed [`UiConfig`] field > default (`false`).
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("FUIGO_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes FUIGO_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
