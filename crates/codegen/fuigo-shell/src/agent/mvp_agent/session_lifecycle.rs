...
impl MvpAgent {
    ...
    pub(crate) fn remove_session(&self, id: &acp::SessionId) {
        let _ = self
            .subagent_event_tx
            .send(fuigo_tools::implementations::fuigo_build::task::types::SubagentEvent::TeardownSession {
        ...
        self.log_resource_usage(fuigo_telemetry::events::ResourceReportTrigger::SessionClose);
    }
