//! The canonical implementation now lives in `fuigo_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use fuigo_tools::retry::BackoffConfig as RetryConfig;
pub use fuigo_tools::retry::{BackoffConfig, execute_with_backoff};
