//! Types are canonical in `fuigo-tools`.
//! This module adds conversions between ACP plan entries and `TodoItem` since `fuigo-tools` is protocol-agnostic.

pub use fuigo_tools::implementations::fuigo_build::todo::TodoId;
pub use fuigo_tools::implementations::fuigo_build::todo::TodoItem;
pub use fuigo_tools::implementations::fuigo_build::todo::TodoPriority;
pub use fuigo_tools::implementations::fuigo_build::todo::TodoState;
pub use fuigo_tools::implementations::fuigo_build::todo::TodoStatus;
