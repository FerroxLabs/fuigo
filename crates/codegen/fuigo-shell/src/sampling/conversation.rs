//! Conversation types: re-exports the canonical set from `fuigo_sampling_types` plus fuigo-shell-specific additions.

use std::collections::HashSet;

pub use fuigo_sampling_types::conversation::*;
...
/// Lives in fuigo-shell because it references shell-internal config and upload types.
#[derive(Debug, Clone)]
...
///
/// Keep the "complete turn" definition in sync with `count_complete_turns` in `fuigo-subagent-resolution/src/context.rs`.
