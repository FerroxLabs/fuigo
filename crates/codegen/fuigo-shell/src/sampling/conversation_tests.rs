...
fn fork_filter_keeps_turn_with_reasoning_between_user_and_assistant() {
    ...
    let mut items = vec![
        ConversationItem::system("sys"),
        ConversationItem::user("q"),
        ConversationItem::Reasoning(fuigo_sampling_types::synthesized_reasoning_item("thinking")),
...
fn fork_filter_keeps_multi_tool_turn_with_reasoning_between_results() {
    ...
    let mut items = vec![
        ConversationItem::system("sys"),
        ConversationItem::user("q"),
        ConversationItem::Reasoning(fuigo_sampling_types::synthesized_reasoning_item("plan")),
        ConversationItem::Assistant(AssistantItem {
            content: String::new().into(),
            tool_calls: vec![
                ToolCall {
        ...
        ConversationItem::Reasoning(fuigo_sampling_types::synthesized_reasoning_item("reflect")),
