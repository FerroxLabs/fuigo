...
use super::model::{API_KEY_SCOPE, AuthMode, AuthStore, FuigoAuth};
...
/// Read the API key from the `fuigo::api_key` scope in auth.json.
pub fn read_api_key(fuigo_home: &Path) -> Option<String> {
