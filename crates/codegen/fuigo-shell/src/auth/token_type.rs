...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&FuigoAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> fuigo_telemetry::events::AuthTokenKind {
        use fuigo_telemetry::events::AuthTokenKind as K;
        match self {
