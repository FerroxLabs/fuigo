...
use fuigo_sampling_types::{ContentPart, ConversationItem, ConversationResponse};
...
fn failed_info() -> fuigo_sampler::SamplingErrorInfo {
...
async fn failed_compaction_replay_preserves_queued_image_strip() {
    ...
    local
        .run_until(async {
            ...
            let checkpoint = crate::session::storage::SessionUpdate::Fuigo(Box::new(
