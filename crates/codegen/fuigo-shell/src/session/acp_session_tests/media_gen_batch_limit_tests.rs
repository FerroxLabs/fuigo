...
use fuigo_tools::implementations::fuigo_build::image_gen::ImageGenTool;
use fuigo_tools::media_gen_limits::DEFAULT_MAX_PARALLEL_IMAGE_GEN;
...
async fn tool_result_text(actor: &SessionActor, call_id: &str) -> String {
    ...
    conv.iter()
        ...
        .find_map(|item| match item {
            fuigo_sampling_types::ConversationItem::ToolResult(tr)
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_tools(vec![
            ...
            let calls: Vec<fuigo_sampling_types::ToolCall> = (0..over)
                .map(|i| fuigo_sampling_types::ToolCall {
            ...
            let spam: Vec<fuigo_sampling_types::ToolCall> = (0..DEFAULT_MAX_PARALLEL_IMAGE_GEN * 2)
                .map(|i| fuigo_sampling_types::ToolCall {
            ...
            let under: Vec<fuigo_sampling_types::ToolCall> = (0..DEFAULT_MAX_PARALLEL_IMAGE_GEN)
                .map(|i| fuigo_sampling_types::ToolCall {
