use fuigo_tools::implementations::fuigo_build::task::types::SubagentCompletionSummary;
use fuigo_tools::reminders::task_completion::format_between_turn_completions;
