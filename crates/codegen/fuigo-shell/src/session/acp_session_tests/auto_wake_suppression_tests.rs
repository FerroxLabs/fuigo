...
async fn genuine_user_start_consumes_deferred_completions_without_notification_turn() {
    ...
    local
        .run_until(async {
            ...
            let body = fuigo_tools::reminders::task_completion::format_monitor_completion(
                &fuigo_tools::types::TaskSnapshot {
                    ...
                    signal: None,
                    completed: true,
                    kind: fuigo_tools::computer::types::TaskKind::Monitor,
                    block_waited: false,
...
struct OneTaskTerminal {
    tasks: Vec<fuigo_tools::computer::types::TaskSnapshot>,
}
#[async_trait::async_trait]
impl fuigo_tools::computer::types::TerminalBackend for OneTaskTerminal {
    async fn run(
        &self,
        _: fuigo_tools::computer::types::TerminalRunRequest,
    ) -> Result<
    ...
    async fn get_task(&self, _: &str) -> Option<fuigo_tools::computer::types::TaskSnapshot> {
        None
    }
    async fn kill_task(&self, _: &str) -> fuigo_tools::computer::types::KillOutcome {
        fuigo_tools::computer::types::KillOutcome::NotFound
    }
...
fn completed_bash_task(id: &str) -> fuigo_tools::computer::types::TaskSnapshot {
    fuigo_tools::computer::types::TaskSnapshot {
        task_id: id.into(),
