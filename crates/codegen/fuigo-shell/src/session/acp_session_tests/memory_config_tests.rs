...
async fn create_injection_ready_actor(
    initial_conversation: Vec<fuigo_sampling_types::ConversationItem>,
) -> SessionActor {
    ...
    local
        .run_until(async {
            let actor = create_injection_ready_actor(vec![
                fuigo_sampling_types::ConversationItem::system("You are a helpful assistant."),
                fuigo_sampling_types::ConversationItem::user(
    ...
    local
        .run_until(async {
            let persisted_block =
                ...
                .unwrap();
            let actor = create_injection_ready_actor(vec![
                fuigo_sampling_types::ConversationItem::system(format!(
