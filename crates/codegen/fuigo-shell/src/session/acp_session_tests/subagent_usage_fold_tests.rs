...
fn usage_rows() -> Vec<(String, fuigo_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use fuigo_tools::implementations::fuigo_build::task::types::SubagentOutstandingReply;
...
fn scripted_outstanding_responder(
    replies: Vec<fuigo_tools::implementations::fuigo_build::task::types::SubagentOutstandingReply>,
