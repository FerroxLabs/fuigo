...
pub use fuigo_telemetry::enums::PrCreationSource;
...
pub struct SessionSignals {
    ...
    // === Bash tool patterns (fuigo_build) ===
...
impl SessionSignalsHandle {
    ...
    pub(crate) fn snapshot_gcs_queue(&self, stats: &fuigo_file_utils::queue::UploadQueueStats) {
        ...
        let _ = self.tx.send(SignalEvent::RecordGcsQueueSnapshot {
            ...
            orphans_cleaned: fuigo_file_utils::queue::last_orphans_cleaned(),
        });
    }
