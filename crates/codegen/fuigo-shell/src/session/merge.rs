...
pub(crate) async fn fetch_lanes(
    ...
    // `fuigo --resume <uuid>` resolves across every cwd
...
mod tests {
    ...
    fn cwd_keys_ignore_a_trailing_separator() {
        assert_eq!(cwd_match_keys("/Users/me/fuigo/"), ["/Users/me/fuigo"]);
    }
    ...
    fn retain_matching_cwd_keeps_only_the_requested_directory() {
        ...
        retain_matching_cwd(&mut remote, &["/Users/me/fuigo".to_owned()]);
    ...
    fn all_metadata_fields_populated_together() {
        ...
        assert_eq!(merged[0].repo_name.as_deref(), Some("fuigo"));
