...
use fuigo_mcp::oauth_config::{McpOAuthConfig, McpOAuthConfigMap};
use fuigo_mcp::servers as inner;
...
pub(crate) fn build_config_resolved_event(
    ...
    let servers = configs
        ...
        .collect();
    fuigo_session_events::Event::McpConfigResolved { servers, disabled }
}
