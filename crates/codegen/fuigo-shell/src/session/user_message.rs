...
use fuigo_workspace::session::git::VcsKind;

// Re-export from fuigo-chat-state; the canonical definition lives there
pub(crate) use fuigo_chat_state::compaction_utils::extract_user_query;
...
// Tests for extract_user_query now live in fuigo_chat_state::compaction_utils.
