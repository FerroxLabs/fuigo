...
//! The markdown render sits in `fuigo-compaction-transcript`, disk I/O in `StorageAdapter`.
use super::SessionActor;
use crate::extensions::notification::CompactionSegmentFile;
use crate::session::persistence::PersistenceMsg;
use fuigo_chat_state::CompactionMode;
use fuigo_chat_state::compaction_utils::format_compact_summary;
use fuigo_compaction_transcript::COMPACTION_DIR;
