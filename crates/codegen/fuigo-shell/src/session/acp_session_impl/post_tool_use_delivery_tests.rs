...
use fuigo_hooks::event::MAX_HOOK_OUTPUT_REPLACEMENT_CHARS;
use fuigo_hooks::result::HookRunResult;
use fuigo_tools::types::output::{MCPOutput, ToolOutput as ToolsToolOutput};

const TAG: &str = fuigo_tools::reminders::DEFAULT_REMINDER_TAG;
