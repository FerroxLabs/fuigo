...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<fuigo_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(fuigo_tools::implementations::fuigo_build::update_goal::UpdateGoalInput),
    Channel(fuigo_tools::implementations::fuigo_build::update_goal::UpdateGoalEnvelope),
}
