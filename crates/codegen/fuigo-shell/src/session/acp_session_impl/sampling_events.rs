...
impl SessionActor {
    ...
    /// Translate one [`fuigo_sampler::SamplingEvent`] from the per-session sampler actor into the corresponding ACP / shell side-effects.
    ///
    ...
    pub(crate) async fn handle_sampling_event(
        self: &Arc<Self>,
        event: fuigo_sampler::SamplingEvent,
    ) {
        use fuigo_sampler::{SamplingChannel, SamplingEvent};
        ...
        match event {
            ...
            SamplingEvent::ToolCallDelta {
                ...
                self.send_buffered_fuigo_update(FuigoSessionUpdate::ToolCallDeltaChunk {
                    tool_call_id: id,
                    tool_index,
                    name,
                    arguments_delta,
            ...
            SamplingEvent::ReasoningCompleted { signature, .. } => {
                ...
                self.send_buffered_fuigo_update(FuigoSessionUpdate::ReasoningCompleted {
            ...
            SamplingEvent::Retrying {
                ...
                if kind == fuigo_sampler::SamplingErrorKind::DoomLoopDetected {
