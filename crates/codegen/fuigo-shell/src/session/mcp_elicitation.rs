...
use fuigo_mcp::elicitation::{
    ElicitationInbox, ElicitationJob, cancel_result, elicit_result_from_wire,
};
use fuigo_mcp::wire::MCP_ELICIT;
use fuigo_tools::mcp_elicitation::{McpElicitExtRequest, McpElicitExtResponse};
...
mod tests {
    use super::*;
    use fuigo_mcp::elicitation::wire_mode_and_fields;
    use fuigo_mcp::rmcp::model::{
