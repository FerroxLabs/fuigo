use fuigo_telemetry::enums::PermissionMode;
...
pub(crate) fn canonical_permission_tool_name(
    access: &fuigo_workspace::permission::AccessKind,
) -> String {
    fuigo_workspace::permission::prompter_tool_name_for_access(access)
}
...
mod permission_analytics_tests {
    ...
    use fuigo_workspace::permission::{ClassifierSecurityFinding, reasons};
    ...
    fn renamed_agent_message_keeps_canonical_product_and_external_identity() {
        let access = fuigo_workspace::permission::AccessKind::AgentMessage {
