...
use fuigo_telemetry::memory_telemetry::{
...
pub(crate) fn log_memory_injection(
    ...
    fuigo_telemetry::session_ctx::log_event(MemoryInjection {
        session_id,
        outcome,
...
impl MemoryObservationSink for TelemetryMemoryObservationSink {
    fn observe_search(&self, observation: MemorySearchObservation) {
        fuigo_telemetry::session_ctx::log_event(MemorySearch {
            ...
            outcome: match observation.outcome {
                fuigo_memory::MemorySearchOutcome::Results => TelemetryOutcome::Results,
                fuigo_memory::MemorySearchOutcome::Empty => TelemetryOutcome::Empty,
                fuigo_memory::MemorySearchOutcome::Error => TelemetryOutcome::Error,
            },
    ...
    fn observe_watcher_sync(&self, observation: MemoryWatcherSyncObservation) {
        fuigo_telemetry::session_ctx::log_event(MemoryWatcherSync {
            session_id: self.session_id.clone(),
