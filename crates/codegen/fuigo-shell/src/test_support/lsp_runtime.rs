...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-fuigo-test"),
        ...
        parent_skills: None,
        parent_skills_config: fuigo_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: fuigo_tools::types::compat::CompatConfig::default(),
