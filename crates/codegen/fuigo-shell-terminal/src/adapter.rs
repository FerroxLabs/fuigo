//! Implements `fuigo-tools::TerminalBackend` over ACP gateway calls, for bash execution when the client serves the terminal.
...
use fuigo_acp_lib::{AcpAgentGatewaySender as GatewaySender, acp_channel_failure};
use fuigo_tools::computer::types::{
...
/// Wraps fuigo-shell's ACP gateway to satisfy fuigo-tools' TerminalBackend.
