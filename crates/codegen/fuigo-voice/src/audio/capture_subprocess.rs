...
//! `FUIGO_VOICE_CAPTURE=inprocess` forces the fallback.
...
/// Env escape hatch: `FUIGO_VOICE_CAPTURE=inprocess` forces the legacy in-process cpal backend (accepting its permanent footprint cost).
const CAPTURE_BACKEND_ENV: &str = "FUIGO_VOICE_CAPTURE";
