...
pub fn elicit_result_from_wire(
    response: &fuigo_tools::mcp_elicitation::McpElicitExtResponse,
) -> ElicitResult {
...
///
/// [`McpElicitExtRequest`]: fuigo_tools::mcp_elicitation::McpElicitExtRequest
#[derive(Debug, Clone)]
pub struct WireElicitFields {
    pub message: String,
    pub mode: fuigo_tools::mcp_elicitation::McpElicitModeFields,
}
...
mod tests {
    ...
    fn wire_mapping_form_and_url() {
        use fuigo_tools::mcp_elicitation::McpElicitModeFields;
        let schema = ElicitationSchema::builder()
    ...
    fn oversized_message_is_declined() {
        use fuigo_tools::mcp_elicitation::MAX_ELICIT_MESSAGE_CHARS;
        let schema = ElicitationSchema::builder()
            .required_property("x", PrimitiveSchemaDefinition::String(StringSchema::new()))
            .build()
            .unwrap();
