//! Public event types — the wire contract for `fuigo-fsnotify`.
//!
...
//! translator (in `fuigo-workspace`) maps these to
...
/// Aligned with `fuigo_workspace_types::FsEventKind` (identity map at
