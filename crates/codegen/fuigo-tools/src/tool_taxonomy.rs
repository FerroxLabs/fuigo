...
//! `ToolInput`, proto, or runtime). A future `fuigo-tool-taxonomy` leaf crate
...
mod tests {
    ...
    fn identity(kind: ToolKind) -> ToolIdentity {
        ToolIdentity {
            tool_kind: kind,
            namespace: ToolNamespace::FuigoBuild,
    ...
    fn writing_tool_kind_matches_definition_sites() {
        ...
        covered(crate::implementations::fuigo_build::SearchReplaceTool);
        covered(crate::implementations::fuigo_build::BashTool);
        covered(crate::implementations::fuigo_build::TodoWriteTool);
        covered(crate::implementations::fuigo_build::WorkflowTool);
        covered(crate::implementations::fuigo_build::ImageGenTool);
        covered(crate::implementations::fuigo_build::ImageEditTool);
        covered(crate::implementations::fuigo_build::ImageToVideoTool);
        covered(crate::implementations::fuigo_build::ReferenceToVideoTool);
        covered(crate::implementations::fuigo_build::AskUserQuestionTool);
        ...
        covered(crate::implementations::fuigo_build_hashline::HashlineEditTool);
    }
    ...
    fn namespace_round_trips_snake_case_with_pascal_aliases() {
        ...
        fn wire_and_pascal(ns: ToolNamespace) -> (&'static str, &'static str) {
            match ns {
                ToolNamespace::FuigoBuild => ("fuigo_build", "FuigoBuild"),
                ToolNamespace::FuigoBuildConcise => ("fuigo_build_concise", "FuigoBuildConcise"),
                ToolNamespace::FuigoBuildHashline => ("fuigo_build_hashline", "FuigoBuildHashline"),
