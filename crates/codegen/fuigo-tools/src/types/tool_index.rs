...
//!
//! `ToolSearchIndex` is defined in `fuigo-tools` to keep the tool crate
//! backend-agnostic. The concrete implementation lives in `fuigo-shell`
...
/// serialized), injected by `fuigo-shell` after MCP initialization.
#[derive(Clone)]
