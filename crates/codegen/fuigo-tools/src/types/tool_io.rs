...
use crate::implementations::fuigo_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::fuigo_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::fuigo_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::fuigo_build::grep::GrepSearchInput;
use crate::implementations::fuigo_build::image_edit::ImageEditInput;
use crate::implementations::fuigo_build::image_gen::ImageGenInput;
use crate::implementations::fuigo_build::list_dir::ListDirInput;
use crate::implementations::fuigo_build::read_file::ReadFileInput;
use crate::implementations::fuigo_build::search_replace::SearchReplaceInput;
use crate::implementations::fuigo_build::send_subagent_message::SendSubagentMessageInput;
use crate::implementations::fuigo_build::todo::TodoWriteInput;
use crate::implementations::fuigo_build::update_goal::UpdateGoalInput;
use crate::implementations::fuigo_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::fuigo_build::web_fetch::WebFetchInput;
use crate::implementations::fuigo_build::web_search::WebSearchInput;
...
use fuigo_tool_types::KillTaskToolInput;
use fuigo_tool_types::TaskOutputToolInput;
use fuigo_tool_types::TaskToolInput;
use fuigo_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::fuigo_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::fuigo_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::fuigo_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::fuigo_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::fuigo_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::fuigo_build::workflow::WorkflowToolInput),
