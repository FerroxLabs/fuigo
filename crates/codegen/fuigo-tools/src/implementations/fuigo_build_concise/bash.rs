...
use crate::implementations::fuigo_build::bash::{
...
impl crate::types::tool_metadata::ToolMetadata for BashConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::FuigoBuildConcise
    }
...
impl fuigo_tool_runtime::Tool for BashConciseTool {
    ...
    async fn run(
        ...
        let result = fuigo_tool_runtime::Tool::run(&BashTool, ctx, input).await?;
...
mod tests {
    ...
    fn no_double_header_after_default_prebake() {
        ...
        bash.output_for_prompt =
            crate::implementations::fuigo_build::bash::format_default_prompt(&bash);
