...
impl fuigo_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> fuigo_tool_protocol::ToolId {
        fuigo_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                fuigo_tool_runtime::ToolError::execution(
                    fuigo_tool_protocol::ToolId::new("memory_search").expect("valid"),
