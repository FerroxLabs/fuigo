...
impl crate::types::tool_metadata::ToolMetadata for HashlineEditTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::FuigoBuildHashline
    }
...
impl fuigo_tool_runtime::Tool for HashlineEditTool {
    type Args = HashlineEditInput;
    type Output = crate::types::output::SearchReplaceOutput;

    fn id(&self) -> fuigo_tool_protocol::ToolId {
        fuigo_tool_protocol::ToolId::new("hashline_edit").expect("valid tool id")
    }
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, fuigo_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<fuigo_tool_runtime::Cwd>() {
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::fuigo_build_hashline::anchor::split_lines;
        use crate::implementations::fuigo_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::fuigo_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    async fn output_is_tool_output_search_replace() {
        ...
        let result: crate::types::output::SearchReplaceOutput =
            fuigo_tool_runtime::Tool::run(&tool, test_ctx(resources.into_shared()), input)
                .await
                .unwrap();
    ...
    fn test_scheme() -> Box<dyn crate::implementations::fuigo_build_hashline::scheme::AnchorScheme> {
        crate::implementations::fuigo_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
