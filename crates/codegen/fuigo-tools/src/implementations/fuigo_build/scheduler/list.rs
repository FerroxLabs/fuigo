...
impl fuigo_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl fuigo_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> fuigo_tool_protocol::ToolId {
        fuigo_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, fuigo_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                fuigo_tool_runtime::ToolError::execution(
                    fuigo_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
