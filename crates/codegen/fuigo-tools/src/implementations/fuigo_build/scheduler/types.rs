...
pub fn scheduler_tool_error(error: SchedulerError) -> fuigo_tool_runtime::ToolError {
    ...
    fuigo_tool_runtime::ToolError::custom(code, error.to_string())
}
...
crate::register_resource!("fuigo_build", "Scheduler", SchedulerState);
