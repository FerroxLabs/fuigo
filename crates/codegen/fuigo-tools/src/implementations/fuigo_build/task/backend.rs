...
use fuigo_tool_runtime::ToolError;
...
pub const VALIDATE_TYPE_TIMEOUT_ENV_VAR: &str = "FUIGO_VALIDATE_TYPE_TIMEOUT_MS";

/// Env-var override for [`DESCRIBE_TYPE_TIMEOUT`] (positive milliseconds).
pub const DESCRIBE_TYPE_TIMEOUT_ENV_VAR: &str = "FUIGO_DESCRIBE_TYPE_TIMEOUT_MS";
