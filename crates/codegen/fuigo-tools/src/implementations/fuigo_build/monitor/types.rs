...
impl fuigo_tool_runtime::ToolOutput for MonitorOutput {}
...
pub struct MonitorEventNotification {
    ...
    /// events inside another session's turn. `None` for legacy / non-fuigo-build
...
///
/// [`EventQueue`]: fuigo_interjection_core::EventQueue
pub type MonitorEventBuffer = fuigo_interjection_core::EventQueue<MonitorEventNotification>;

crate::register_resource!("fuigo_build", "MonitorEventBuffer", MonitorEventBuffer);
